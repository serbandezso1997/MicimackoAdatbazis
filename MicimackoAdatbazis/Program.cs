...
namespace MicimackoAdatbazis
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Elsőnek törlöm az adatbázis korábbi tartalmát
            string torloUtasitas = "DELETE FROM `Szereplok`;";
            parancs.CommandText = torloUtasitas;
            parancs.ExecuteNonQuery();
            for (int i = 0; i < utasitasokLista.Count; i++) 
            {
                parancs.CommandText = utasitasokLista[i];
                if (utasitasokLista[i].Contains("SELECT"))
                {
            ...
            //Console.WriteLine("a lekérdezett első eleme:" +lekerdezett[0]);
        ...
        */
        ...
        {
            List <string> kiMitSzeret = new List <string>();
            //a mese szereplői (9fő)
            string[] szereplok = new string[] {
                "Micimackó",
                "Malacka",
                  ...
                  zsedb == 0 || bagdb == 0 || tigdb == 0)
            {
                ...
                Console.WriteLine($"{sor + 1}. {szereplok[vel1]} szereti:{gyum[vel2]}");
                kiMitSzeret.Add(szereplok[vel1] + " - " + gyum[vel2]);
                sor++;
            }
            return kiMitSzeret;
        }
        ...
        static List<string> SqlUtasitasok()
        {
            ...
            while ( !olvas.EndOfStream )
            {
                ...
                //foreach ( string s in sor ) Console.WriteLine(s);
            ...
            Console.WriteLine("első utasítás: " + sqlUtasitasok[0]);
            olvas.Close();
